...
class CommonListTileRadioListSearch extends StatefulWidget {
  final bool needTrailing;
  final String trailString;
  final List<Option> list;

  const CommonListTileRadioListSearch({
    Key? key,
  ...
  @override
  State<CommonListTileRadioListSearch> createState() =>
      _CommonListTileRadioListSearchState();
}

class _CommonListTileRadioListSearchState extends State<CommonListTileRadioListSearch> {
  @override
  Widget build(BuildContext context) {
    final ValueNotifier<int> _value =
        ValueNotifier<int>(context.read<SearchProductProvider>().discountIndex);
                ...
                return InkWell(
                  onTap: () {
                    ...
                    context
                        ...
                        .changeDiscountValue(list: widget.list, index: index);
                  },
                  child: Container(
