  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: CommonAppBar(
          pageTitle: "Filters",
          actionList: [
            context.read<ProductProvider>().loaderStates == LoaderState.loaded
                ? InkWell(
                    ...
                    onTap: () {
                      maxValue = 0.0;
                      minValue = 0.0;
                      context.read<ProductProvider>().previousMaxValue =
                          maxValue;
                      context.read<ProductProvider>().previousMinValue =
                          minValue;
                      context.read<ProductProvider>().clearAll(context,resetFilter: true,clearSort: false);
                    },
                    child: SizedBox(
                      child: Padding(
